-- virtcat_recv.sql
--
-- ILL's received from the virtual catalog (copy owning library = 38)
-- 6/1/2013 include aged_circulation

SELECT aou.name AS "Circulating Library", aou2.shortname AS "Owning Library", COUNT(acirc.id) AS "COUNT"
...
SELECT aou.name AS "Circulating Library", aou2.shortname AS "Owning Library", COUNT(aged.id) AS "COUNT"
